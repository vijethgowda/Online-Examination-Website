 ...
 if($_POST['psw']=="")
  ...
  if($error=="")
  {
   include("connection.php");
    ...
    $query="SELECT * FROM `Student` WHERE Student_id='".mysqli_real_escape_string($link,$_POST['usn'])."' LIMIT 1";
    ...
    if(mysqli_num_rows($result)>0)
    {
       while ($row=mysqli_fetch_array($result))   
       {
           ...
           else
           {
            ...
            $error.="Password OR USN Incorrect<br>";
    ...
    {
    $error.="Looks Like You Haven't Registerd Yet please Do Sign Up Before Loging In"; 
    }
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
         <a class="nav-link" href="#" onclick="document.getElementById('id01').style.display='block'">Login <span class="sr-only"></span></a>
      </li>
    </ul>
  </div>
</nav>
